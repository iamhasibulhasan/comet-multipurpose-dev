...
<head>
    <title>Comet | Creative Multi-Purpose System</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <link rel="stylesheet" href="{{ asset('forntend/css/bundle.css') }}">
...
<header id="topnav">
    <div class="container">
        ...
        <div class="logo">
            <a href="index-2.html">
                <img src="forntend/images/logo_light.png" alt="" class="logo-light">
                <img src="forntend/images/logo_dark.png" alt="" class="logo-dark">
            </a>
        </div>
        <!-- End Logo container-->
                        ...
                        <ul class="nav product-list">
                            <li>
                                <div class="product-thumbnail">
                                    <img src="forntend/images/shop/2.jpg" alt="">
                                </div>
                            ...
                            <li>
                                <div class="product-thumbnail">
                                    <img src="forntend/images/shop/5.jpg" alt="">
                                </div>
                                <div class="product-summary">
...
<section class="page-title parallax">
    <div data-parallax="scroll" data-image-src="forntend/images/bg/18.jpg" class="parallax-bg"></div>
